...
import infernoLogo from "./assets/inferno.svg";
...
export default [
	...
	, {
		description: "If you can build a website, you can build a desktop app. Electron is a framework for creating native applications with web technologies like JavaScript, HTML, and CSS."
		, featured: false
		, id: 3
		, logo: electronLogo
		, name: "Electron"
	...
	, {
		description: "Don't waste time making trivial choices. Ember.js incorporates common idioms so you can focus on what makes your app special, not reinventing the wheel."
		, featured: false
		, id: 4
		, logo: emberLogo
		, name: "Ember"
	...
	, {
		description: "React makes it painless to create interactive UIs. Design simple views for each state in your application, and React will efficiently update and render just the right components."
		, featured: true
		, id: 8
		, logo: reactLogo
		, name: "React"
